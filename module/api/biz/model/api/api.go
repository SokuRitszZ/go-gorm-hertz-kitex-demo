...
type CreateUserRequest struct {
	Name     string `thrift:"name,1" form:"name" json:"name" vd:"len($) > 0"`
...
func (p *CheckUserRequest) GetName() (v string) {
	return p.Name
}
...
type QueryNoteResponse struct {
	BaseResp *BaseResp `thrift:"base_resp,1" form:"base_resp" json:"base_resp" query:"base_resp"`
	Notes    []*Note   `thrift:"notes,2" form:"notes" json:"notes" query:"notes"`
...
func (p *QueryNoteResponse) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("notes", thrift.LIST, 2); err != nil {
		goto WriteFieldBeginError
	}
...
type ApiService interface {
	CreateUser(ctx context.Context, req *CreateUserRequest) (r *CreateUserRequest, err error)
...
func (p *ApiServiceClient) CreateUser(ctx context.Context, req *CreateUserRequest) (r *CreateUserRequest, err error) {
...
type ApiServiceCreateUserResult struct {
	Success *CreateUserRequest `thrift:"success,0,optional"`
}
...
var ApiServiceCreateUserResult_Success_DEFAULT *CreateUserRequest

func (p *ApiServiceCreateUserResult) GetSuccess() (v *CreateUserRequest) {
	if !p.IsSetSuccess() {
...
func (p *ApiServiceCreateUserResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewCreateUserRequest()
